<footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2019 <a href="<?= base_url('assets/vendor/'); ?>https://adminlte.io">AdminLTE</a>.</strong> All rights
    reserved.
</footer>
...
<aside class="control-sidebar control-sidebar-dark" style="display: none;">
    ...
    <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
        <li><a href="<?= base_url('assets/vendor/'); ?>#control-sidebar-home-tab" data-toggle="tab"><i class="fa fa-home"></i></a></li>
        <li><a href="<?= base_url('assets/vendor/'); ?>#control-sidebar-settings-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
    </ul>
    <!-- Tab panes -->
    <div class="tab-content">
        ...
        <div class="tab-pane" id="control-sidebar-home-tab">
            ...
            <ul class="control-sidebar-menu">
                <li>
                    <a href="<?= base_url('assets/vendor/'); ?>javascript:void(0)">
        ...
        <div class="tab-pane" id="control-sidebar-settings-tab">
            <form method="post">
                ...
                <div class="form-group">
                    <label class="control-sidebar-subheading">
                        Delete chat history
                        <a href="<?= base_url('assets/vendor/'); ?>javascript:void(0)" class="text-red pull-right"><i class="fa fa-trash-o"></i></a>
                    </label>
                </div>
                <!-- /.form-group -->
            </form>
...
<script>
    $(function() {
        ...
        $('.konfir').on('click', function() {
            let nip = $(this).data('nip');

            $.ajax({
                url: "<?= base_url(); ?>admin/getNip",
                method: "post",
                data: {
                    nip: nip
                },
