<div class="container"><br><br>
	<div class="row">
		<div class="col-md-6 mt-5 pt-3" style="border: 2px solid #E0FFFF;">
			...
			<button type="button" id="popo" class="btn btn-sm btn-warning" data-id="pop" data-toggle="popover" title="Perhatian!" data-content="Silahkan siapkan berkas persyaratan sesuai prosedur untuk kelancaran pada saat pengajuan pensiun!"><i class="fas fa-exclamation-circle"></i></button>
